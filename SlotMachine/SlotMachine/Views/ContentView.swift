        ...
        ZStack {
            ...
            // MARK: - Header
                ...
                VStack(alignment:.center,spacing: 0){
                    ...
                    ZStack {
                        ReelView()
                        Image(symbols[reels[0]]).resizable()
                    ...
                    HStack(){
                        ...
                        ZStack {
                            ReelView()
                            Image(symbols[reels[1]]).resizable()
                                .modifier(ImageModifier())
                                .opacity(animatingSymbol ? 1 : 0)
                                .offset(y:animatingSymbol ? 0 : -50)
                                .animation(.easeOut(duration: Double.random(in: 0.5...0.7)))
                        ...
                        ZStack {
                            ReelView()
                            Image(symbols[reels[2]]).resizable()
                                .modifier(ImageModifier())
                                .opacity(animatingSymbol ? 1 : 0)
                                .offset(y:animatingSymbol ? 0 : -50)
                                .animation(.easeOut(duration: Double.random(in: 0.5...0.7)))
                ...
                HStack{
                    ...
                    HStack(alignment:.center,spacing: 10) {
                        Button(action: {self.activateBet20()}){
                            Text("20")
                                .fontWeight(.heavy)
                    ...
                    HStack(alignment:.center,spacing: 10) {
                        Image("gfx-casino-chips")
                            ...
                            .modifier(CasinoChipsModifier())
                        Button(action: {self.activateBet10()}){
                            Text("10")
                                .fontWeight(.heavy)
            ...
            .overlay(
                Button(action: {self.showingInfoView=true}){
            ...
            if $showingModal.wrappedValue{
                ZStack{
                    ...
                    VStack(spacing:0){
                        Text("Game Over").font(.system(.title,design: .rounded))
                            .fontWeight(.heavy)
                            .padding()
                        ...
                        VStack(alignment:.center,spacing:16){
                            Image("gfx-seven-reel").resizable().scaledToFit()
                                .frame(maxHeight: 72)
                            ...
                            Button(action:{self.showingModal = false
                                ...
                                self.coins = 100}){
                                    Text("New Game".uppercased())
                                        ...
                                        .padding(.vertical,8)
                                        .frame(minWidth: 128)
                                        .background(Capsule().strokeBorder(lineWidth: 1.75).foregroundColor(Color("ColorPink"))
                                )
                            }
                        }
                        Spacer()
